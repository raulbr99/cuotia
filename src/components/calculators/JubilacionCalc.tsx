  ...
  return (
    <div className="grid gap-6 md:grid-cols-[1fr_320px]">
      <div className="rounded-xl border border-[#1A1A1A] bg-[#0F0F0F] p-6 space-y-5">
        ...
        <div className="rounded-lg bg-[#0A0A0A] p-4 text-xs space-y-1">
          <p className="font-semibold">Coeficientes 2027:</p>
          <ul className="list-disc list-inside text-[#A0A0A0]">
            <li>15 años: 50%</li>
      ...
      <div className="space-y-4">
        <div className="rounded-xl border-2 border-[#D1FF26] bg-[#0F0F0F] p-5">
          <p className="text-xs uppercase tracking-wider text-[#D1FF26] font-medium">Pensión mensual estimada</p>
          <p className="text-3xl font-bold text-[#D1FF26] mt-1">{eur(result.pension)}</p>
        ...
        <div className="rounded-xl border border-[#1A1A1A] bg-[#0F0F0F] p-5 text-sm space-y-2">
          <div className="flex justify-between"><span className="text-[#606060]">Base reguladora</span><span className="font-medium">{eur(result.baseReguladora)}</span></div>
          <div className="flex justify-between"><span className="text-[#606060]">% aplicado</span><span className="font-medium">{pct(result.porcentaje)}</span></div>
          <div className="flex justify-between"><span className="text-[#606060]">Edad jubilación</span><span className="font-medium">{result.edadJubilacion} años</span></div>
        </div>
