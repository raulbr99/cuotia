        ...
        <div className="grid gap-10 text-sm md:grid-cols-12">
          <div className="md:col-span-4">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 rounded-md bg-[#B91C1C] px-3 py-1.5 text-[12px] font-medium text-white transition-opacity hover:opacity-90"
              aria-label="Apoyar el proyecto en Ko-fi"
            >
              <svg
            ...
            <p className="mt-2 text-[11px] text-neutral-500 italic">
              Cada café ayuda a mantener Cuotia gratis y sin anuncios.
            </p>
          </div>
