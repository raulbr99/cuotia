  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <article className="prose prose-gray max-w-none">
        ...
        <div className="not-prose rounded-xl border border-gray-200 bg-white overflow-hidden my-6">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-right text-gray-500">Tu tramo normal</td>
        ...
        <div className="not-prose rounded-xl border border-gray-200 bg-white overflow-hidden my-6">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100 text-sm">
              <tr><td className="px-4 py-2">1.200 €/mes</td><td className="px-4 py-2 text-right">290 €/mes</td><td className="px-4 py-2 text-right text-emerald-600">87 €/mes</td><td className="px-4 py-2 text-right font-semibold">2.436 €</td></tr>
              <tr><td className="px-4 py-2">2.000 €/mes</td><td className="px-4 py-2 text-right">370 €/mes</td><td className="px-4 py-2 text-right text-emerald-600">87 €/mes</td><td className="px-4 py-2 text-right font-semibold">3.396 €</td></tr>
              <tr><td className="px-4 py-2">3.000 €/mes</td><td className="px-4 py-2 text-right">440 €/mes</td><td className="px-4 py-2 text-right text-emerald-600">87 €/mes</td><td className="px-4 py-2 text-right font-semibold">4.236 €</td></tr>
              <tr><td className="px-4 py-2">5.000 €/mes</td><td className="px-4 py-2 text-right">515 €/mes</td><td className="px-4 py-2 text-right text-emerald-600">87 €/mes</td><td className="px-4 py-2 text-right font-semibold">5.136 €</td></tr>
            </tbody>
          </table>
        </div>
