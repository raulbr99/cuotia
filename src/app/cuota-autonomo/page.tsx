  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <article className="prose prose-gray max-w-3xl text-sm text-[#D0D0D0] space-y-5">
        ...
        <h2 className="text-xl font-bold text-white">Tarifa plana 2025</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-white">Cuota mínima vs máxima</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-white">¿Cuándo se regulariza?</h2>
        <p>
